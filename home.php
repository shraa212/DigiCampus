    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="canteen.php" class="nav-item nav-link ">Canteen</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">The Goal Of Education Is The Advancement Of Knowledge</h5>
                                <h1 class="display-3 text-white animated slideInDown">Take the first step of knowledge with us</h1>
                                <p class="fs-5 text-white mb-4 pb-2">DR.D.Y PATIL INSTITUTE OF TECHNOLOGY</p>
                                <a href="about.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                                <a href="Attendance/index.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/college8.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Welcome</h6>
                    <h1 class="mb-4">Welcome to Institute of Technology</h1>
                    <p class="mb-4">We realize that education is essential for the complete improvement of individuals. As we grow, we will expand into new various technologies, different methodologies, resources and attitudes.</p>
                    <p class="mb-4">To achieve this, our Institute of Technology will ensure the highest quality of faculty, resources, healthy environment and infrastructure.</p>
                    <p class="mb-4">
                    These will be structured with a focus on academic quality. That will meet the ever-increasing requirements of the students. Supporting this is the college assurance to quality education and research. This will promote and assure students in their recreation of knowledge.</p>

                    <p class="mb-4"><b>We provide:</b></p><br>
                    <div class="row gy-2 gx-4 mb-4">
                        ...
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Transportation Facilities.</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>And Many More</p>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
             ...
             <br>
             <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">OUR COLLEGE</h6>
                <h1 class="mb-5">Some Insigths Of Institute</h1>

            <center>
                <img src="college6.jpg" height="300px" width="300px">&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="college1.jpg" height="300px" width="300px">&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="college4.jpg" height="300px" width="300px">
            </center>
            </div>      
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="text" name="ft" placeholder="Your Comment">
                        <button type="submit" name="fb" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">Submit</button>
                    </div>
                </div>
            </div>
        </div>
...
$c = $_POST['ft'];
$sql = "INSERT INTO feedback (comment) VALUES ('$c')";

if ($conn->query($sql) === TRUE) {
  echo "Thankyou for valuable Time";
} else {
