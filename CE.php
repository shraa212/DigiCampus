                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                           ...
                           <a href="syllabus/SECE.pdf" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="syllabus/TECE.pdf" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="syllabus/BECE.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
            </div>
