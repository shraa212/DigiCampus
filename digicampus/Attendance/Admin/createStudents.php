...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,email,admissionNumber,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$emailAddress','$admissionNumber','12345','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 email='$emailAddress', admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" name="emailAddress" value="<?php echo $row['email'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
