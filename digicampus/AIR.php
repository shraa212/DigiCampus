        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">SYLLABUS</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="home.php">Home</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">E-Content</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <h5 class="mb-3">FIRST YEAR</h5>
                             <a href="syllabus/FE.pdf" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fa fa-3x fa-graduation-cap text-primary mb-4"></i>
                            <h5 class="mb-3">SECOND YEAR</h5>
                           <a href="syllabus/SEAIR.pdf" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fa fa-3x fa-graduation-cap text-primary mb-4"></i>
                            <h5 class="mb-3">THIRD YEAR</h5>
                            <a href="syllabus/TEAIR.pdf" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fa fa-3x fa-graduation-cap text-primary mb-4"></i>
                            <h5 class="mb-3">FOURTH YEAR</h5>
                            <a href="syllabus/BEAIR.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Syllabus</a>
                        </div>
                    </div>
                </div>
            </div>
